...
{
    char *train_images = "/home/dnn_benchmark/darknet/train.txt";
    char *backup_directory = "/home/dnn_benchmark/darknet/backup/";
    srand(time(0));
...
void validate_yolo(char *cfg, char *weights)
{
    ...
    // Specifies a text file or something maybe with the correct labels.
    list *plist = get_paths("/home/CUDAclass/aic1080-test2/data_val_test.txt");
    char **paths = (char **)list_to_array(plist);
    char *base = "results/nvidia_validation_";
